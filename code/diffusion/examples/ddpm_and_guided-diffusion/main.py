...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--exp", type=str, default="code/diffusion/exp", help="Path for saving running related data."
    )
    ...
    parser.add_argument(
        "--dataset_generate",
        action="store_true",
        help="Whether to generate (model schedule, metric) dataset for predictor"
    )
    ...
    parser.add_argument("--use_model_schedule", action="store_true", default=False)
    parser.add_argument("--load_population", type=str, default=None)
...
def main():
    ...
    try:
        ...
        if args.load_population is not None:
            runner.population_eval()
        elif args.dataset_generate:
            runner.dataset_generate()
        elif args.sample:
            runner.sample()
        elif args.test:
            runner.test()
